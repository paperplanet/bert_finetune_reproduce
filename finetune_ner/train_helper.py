...
def get_args_parser():
    from .bert_ner import __version__
    parser = argparse.ArgumentParser()
    if os.name == 'nt':
        bert_path = 'F:\chinese_L-12_H-768_A-12'
        root_path = r'C:\workspace\python\BERT-BiLSTM-CRF-NER'
    else:
        bert_path = '/home/a/ml/data/chinese_L-12_H-768_A-12/'
        root_path = '/home/a/ml/workspace/BERT-BiLSTM-CRF-NER'
    ...
    group2.add_argument('-enable_lstm', type=bool, default=False,
                        help='whether to use bi-lstm layers after bert embedding output.')
    ...
    group2.add_argument('-decode', type=str, default='crf',
                        help='decode layer crf/softmax')
