...
def create_model(bert_config, is_training, input_ids, input_mask,
                 ...
                 dropout_rate=1.0, lstm_size=1, cell='lstm', num_layers=1, decode='crf', enable_lstm=False):
    """
    创建X模型
    ...
    rst = blstm_crf.add_blstm_crf_layer(enable_lstm=enable_lstm,decode=decode)
    return rst
